...
describe("VoyageRerankAdapter", () => {
  it("returns indices sorted by relevance_score descending", async () => {
    ...
    const adapter = new VoyageRerankAdapter("test-key", "rerank-2");
  ...
  it("sends request with correct auth header and body", async () => {
    ...
    const adapter = new VoyageRerankAdapter("my-key", "rerank-2");
  ...
  it("throws on non-ok API response", async () => {
    ...
    const adapter = new VoyageRerankAdapter("bad-key", "rerank-2");
  ...
  it("handles response with unordered relevance scores", async () => {
    ...
    const adapter = new VoyageRerankAdapter("key", "rerank-2");
