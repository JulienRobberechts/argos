...
export default [
  // Chunk 1
  "# Orient-Express\n\n**Blanche El Gammal**\n\n---\n\n**Référence électronique**\n\nBlanche El Gammal, *Orient-Express*. Publictionnaire. Dictionnaire encyclopédique et critique des publics. Mis en ligne le 13 décembre 2023. Accès : https://publictionnaire.huma-num.fr/notice/orient-express/\n\nLe Publictionnaire. Dictionnaire encyclopédique et critique des publics est un dictionnaire collaboratif en ligne sous la responsabilité du Centre de recherche sur les médiations (Crem, Université de Lorraine) ayant pour ambition de clarifier la terminologie et le profit heuristique des concepts relatifs à la notion de public et aux méthodes d'analyse des publics pour en proposer une cartographie critique et encyclopédique.\n\nAccès : https://publictionnaire.huma-num.fr",

  // Chunk 2
  "Accès : https://publictionnaire.huma-num.fr\n\n*Cette notice est mise à disposition selon les termes de la licence Creative Commons Attribution - Pas d'utilisation commerciale - Pas de modification 3.0 France.*\n\n---\n\nLancé en 1883, l'Orient-Express connaît un succès immédiat pour deux raisons au moins : il est à la fois le premier train de luxe européen et le premier train international européen. Conçu et perçu comme un hôtel sur rail, il est pour ses passagers une sorte de tapis magique reliant Paris à Constantinople en un peu moins de trois jours.",

  // Chunk 3
  "Conçu et perçu comme un hôtel sur rail, il est pour ses passagers une sorte de tapis magique reliant Paris à Constantinople en un peu moins de trois jours. Paré de toutes les séductions dans l'imaginaire collectif, il est associé à l'Orient, au luxe, à la Belle Époque, aux Années Folles, aux grands personnages qui l'ont pris ou supposément pris, comme Mata Hari (1876-1917) ou Joséphine Baker (1906-1975), au célèbre *Crime* d'Agatha Christie (1890-1976).",

  // Chunk 4
  "Son histoire n'est pourtant pas réductible à ces beaux mots et ces noms prestigieux, lesquels relèvent pour une part d'une doxa qui n'a cessé de s'embellir au fil des années. Si d'indispensables données historiques et géographiques doivent être ici rappelées, l'accent sera mis sur le public des voyageurs, les images qui en sont données dans la littérature et les multiples formes de publicité qui ont fait la renommée du train.\n\n*L'Orient-Express près d'Istanbul, carte postale, c. 1900. Source : Wikimedia (domaine public).*\n\n---\n\n## Le projet et les débuts (1870-1914)\n\nL'Orient-Express, on s'en doute, n'a pas été créé *ex nihilo*.",

  // Chunk 5
  "*L'Orient-Express près d'Istanbul, carte postale, c. 1900. Source : Wikimedia (domaine public).*\n\n---\n\n## Le projet et les débuts (1870-1914)\n\nL'Orient-Express, on s'en doute, n'a pas été créé *ex nihilo*. Son inventeur, l'ingénieur liégeois **Georges Nagelmackers** (1845-1905), s'est rendu aux États-Unis dans les années 1860 et a rapporté de son voyage deux idées qui doivent aux réalisations de l'industriel George M. Pullman (1831-1897).",

  // Chunk 6
  "Pullman (1831-1897). La première est la suivante : de même que les États américains ont été reliés par le chemin de fer, de même le train, et en particulier l'Orient-Express, devra relier les États qu'il traverse en Europe (Des Cars, Caracalla, 1984 : 16). La seconde idée consiste à reproduire, avec quelques adaptations et améliorations, le luxe des voitures américaines, réputées très confortables. De retour en Europe, G. Nagelmackers publie en 1870 une plaquette intitulée *Projet d'installation de wagons-lits sur les chemins de fer du continent*.",

  // Chunk 7
  "De retour en Europe, G. Nagelmackers publie en 1870 une plaquette intitulée *Projet d'installation de wagons-lits sur les chemins de fer du continent*.\n\nLe projet est totalement inédit en Europe, où l'on ne connaît ni les trains internationaux, ni les trains de luxe. Il est donc audacieux, mais G.",

  // Chunk 8
  "Le projet est totalement inédit en Europe, où l'on ne connaît ni les trains internationaux, ni les trains de luxe. Il est donc audacieux, mais G. Nagelmackers peut compter sur le soutien des membres de sa très influente famille, une des plus puissantes à Liège : son grand-père était le fondateur de la très réputée Banque Nagelmackers ; son père est ingénieur ; son oncle Walthère Frère-Orban (1812-1896) est une personnalité de premier ordre, ingénieur lui aussi, fondateur du parti libéral de Belgique en 1846, ministre des Finances puis Premier ministre du royaume.",

  // Chunk 9
  "Ses cousins de la famille Orban, banquiers, ingénieurs et juristes, facilitent aussi les contacts dans le milieu des affaires et de la finance. Last but not least, Nagelmackers obtient l'appui du roi des Belges, Léopold II (1835-1909) (Mettetal, 2022 : 49-52).\n\nDes retards et des difficultés surviennent toutefois : la guerre franco-prussienne et son règlement compliquent les collaborations internationales d'une part ; de l'autre, toutes les voies ferroviaires que doivent emprunter les nouveaux trains ne sont pas encore achevées. G.",

  // Chunk 10
  "G. Nagelmackers parvient néanmoins à convaincre les États et les administrations ferroviaires de l'intérêt de faire circuler sur leurs territoires et leurs réseaux des trains de luxe internationaux (ibid. : 23). Après des changements de noms et de statuts, la **Compagnie Internationale des Wagons-Lits** est créée en 1876. L'Orient-Express est le premier train de luxe international de la Compagnie et donc son fleuron, mais c'est en fait un train parmi d'autres (songeons au Nord-Express, au Sud-Express ou au Transsibérien).",
  ...
  // Chunk 12
  "Avec l'achèvement des tronçons serbe et bulgare, le trajet se fait exclusivement par voie terrestre par Belgrade et Sofia à partir de 1889. Il est aussi possible de traverser la mer Noire à destination de Constantinople depuis Constantza, en Roumanie, à partir de 1895.\n\n*Les routes de l'Orient-Express, de son lancement en 1883 à la Première Guerre mondiale. Source : Wikimedia (CC BY-SA 3.0).*\n\nConstantinople, c'est la Sublime Porte de l'Orient chantée par tout le XIXe siècle et le courant orientaliste, qu'il s'agisse des poètes ou des peintres.",

  // Chunk 13
  "Source : Wikimedia (CC BY-SA 3.0).*\n\nConstantinople, c'est la Sublime Porte de l'Orient chantée par tout le XIXe siècle et le courant orientaliste, qu'il s'agisse des poètes ou des peintres. L'arrivée de l'Orient-Express dans la ville est aussi contemporaine des romans turcs de **Pierre Loti** (1850-1923), qui connaissent un grand succès — citons *Aziyadé* (1878), *Fantôme d'Orient* (1892) et *Les Désenchantées* (1906).",

  // Chunk 14
  "Les voyageurs ont donc désormais accès au rêve oriental, si fantasmé soit-il ; les premières affiches publicitaires de l'Orient-Express ne manquent d'ailleurs pas de présenter les traditionnelles images associées à l'Orient : ainsi des coloris chauds, des portes aux formes arrondies et des mosquées aux minarets élevés.",
  ...
  // Chunk 22
  "C'est un train extrêmement cher, et il n'est pas exagéré de dire que c'est un palace sur rail ; ça l'est au sens propre, puisqu'il faut reproduire le luxe des hôtels que fréquente la clientèle, d'où la présence de matériaux nobles (cuir de Cordoue, velours de Gênes) et d'un mobilier de style Louis XV dans les voitures. Le luxe consiste aussi à ne pas devoir changer de train au passage des frontières et à se déplacer vite : l'Orient-Express est le moyen de transport le plus rapide pour se rendre d'une grande ville du parcours à Constantinople.",

  // Chunk 23
  "On comprend dès lors que les notes exaltées abondent dans les récits de voyage ou dans la correspondance des *happy few* qui empruntent à l'occasion ou régulièrement l'Orient-Express : c'est à la fois le train des hommes d'affaires puissants, des ingénieurs de talent, des têtes couronnées et d'une élite intellectuelle et artistique.\n\nL'effet tapis magique opère et pourtant... Le projet d'unifier l'Europe par l'Orient-Express est grandement compromis d'entrée de jeu.",

  // Chunk 24
  "L'effet tapis magique opère et pourtant... Le projet d'unifier l'Europe par l'Orient-Express est grandement compromis d'entrée de jeu. Le train a été créé sur fond de guerre latente : c'est bien sûr la défaite de la France contre l'Allemagne en 1871 (la traversée de Strasbourg est douloureusement vécue par les voyageurs français, qui tiennent des propos amers et acerbes), mais il y a aussi des conflits dans les Balkans : dès la fin du siècle, les Macédoniens bulgares mécontents des partages décidés par les grandes puissances au Traité de Berlin commettent plusieurs attentats sur le parcours oriental du train.",

  // Chunk 25
  "Ces insurgés veulent faire sauter l'Orient-Express pour alerter l'opinion internationale de leur sort ; or la situation dans les Balkans s'aggrave avec les guerres balkaniques de 1912-1913. Toutes ces tensions sont visibles à l'intérieur et à l'extérieur du train : en témoignent les conversations inquiètes des voyageurs, qui ont conscience de parcourir une route armée à l'approche de la Première Guerre mondiale (Lauzanne, 1913).\n\n---\n\n## Le train à l'épreuve de l'Histoire : l'évolution des trajets et des voyageurs (1914-1977)\n\nLe train est arrêté en juillet 1914.",

  // Chunk 26
  "---\n\n## Le train à l'épreuve de l'Histoire : l'évolution des trajets et des voyageurs (1914-1977)\n\nLe train est arrêté en juillet 1914. Pendant la guerre, il est repris et détourné de son trajet par la compagnie allemande Mitropa. L'Orient-Express devient le **Balkanzug**, le train des Balkans reliant Berlin à Constantinople par les pays alliés à l'Allemagne : l'idée est d'en faire le premier tronçon de la Bagdadbahn, le grand projet de Guillaume II (1859-1941) visant à relier Berlin au Moyen-Orient.\n\n*Les routes du Balkanzug (1916-1918). Source : Wikimedia (CC BY-SA 3.0).*\n\nL'Orient-Express change d'itinéraire après-guerre.",
  ...
  // Chunk 31
  "C'est aussi le temps des affiches Art Déco signées par de grands noms, à l'instar de **Cassandre** (1901-1968). L'Orient-Express devient donc un objet d'art (Mettetal, 2022 : 259-290).\n\nÀ cela s'ajoute un formidable essor de la Compagnie avec la multiplication et le prolongement des lignes : outre le Simplon-Orient-Express, l'Arlberg-Express, emprunté par les nombreux amateurs de paysages autrichiens, devient l'Arlberg-Orient-Express en 1932 ; surtout, la Compagnie lance le **Taurus-Express** en 1930, année où Constantinople devient Istanbul : à partir de la rive asiatique de la ville, on peut désormais atteindre Bagdad-Bassora à l'est, Jérusalem-Le Caire à l'ouest.",

  // Chunk 32
  "Un nouveau record est battu, puisqu'il faut désormais huit jours pour relier Londres à Bagdad, là où il fallait plusieurs semaines auparavant : si quelques trajets du parcours se font dans un premier temps en voiture, un gain de temps de 24 heures est possible à partir de 1940, avec l'achèvement des tronçons ferroviaires manquants, par exemple entre Mossoul et Bagdad.",

  // Chunk 33
  "C'est en fait là le rêve de la Bagdadbahn, initié par Guillaume II au début du siècle, qui devient réalité, mais récupéré à leur profit par les Français et les Britanniques, qui détiennent respectivement des mandats en Syrie et en Irak. Cette nouvelle mainmise est rendue possible par les travaux assez largement entamés de la Bagdadbahn, dont le chantier a été interrompu en 1912 à Alep, mais aussi grâce à l'amélioration progressive des relations entre la Turquie et l'Irak. Dès lors, on peut envisager, à partir de Bassora, de gagner Bombay.",

  // Chunk 34
  "Dès lors, on peut envisager, à partir de Bassora, de gagner Bombay. D'une certaine façon, les Anglais réalisent un grand projet qui remonte aux années 1850 : celui de bâtir une « world's highway » qui irait de l'Europe du Nord à l'Inde.\n\nL'Orient-Express des années 1920 est aussi le train des Années Folles associé aux images de luxe, d'insouciance et de grivoiserie véhiculées par *La Madone des Sleepings*, héroïne du best-seller de **Maurice Dekobra** (1885-1973) paru en 1925.\n\nLe propos doit toutefois être nuancé.",

  // Chunk 35
  "Le propos doit toutefois être nuancé. À côté de toutes ces enthousiasmantes réalisations, de nouvelles classes sont introduites (il n'y avait qu'une classe jusqu'ici), donc de nouvelles populations : ce sont les exilés, les malheureux, les trafiquants et les criminels qu'on retrouve dans toute la littérature Orient-Express de l'entre-deux-guerres, qui est particulièrement sombre. **Paul Morand** (1888-1976 ; 1922) évoque ainsi des voyageurs du Simplon-Orient-Express harassés dans « La nuit turque » ; on y voit des couturières, des modistes, des femmes du Civil Service et un escroc se côtoyer dans le plus grand inconfort (ibid. : 73-75).",

  // Chunk 36
  "La Madone des Sleepings elle-même est en fait ruinée ; elle ne prend l'Orient-Express qu'à la fin du roman dans l'espoir de regagner l'argent qu'elle a perdu dans des placements inconsidérés (Dekobra, 1925 : 307-313). C'est son chevalier servant Gérard qui prend les grands express ; ses aventures ferroviaires à elle appartiennent au passé. Les années 1930 sont plus noires encore dans la littérature Orient-Express, et on ne trouve pas un seul éloge du train ou de ses voyageurs dans le *Crime* d'A. Christie.",

  // Chunk 37
  "Les années 1930 sont plus noires encore dans la littérature Orient-Express, et on ne trouve pas un seul éloge du train ou de ses voyageurs dans le *Crime* d'A. Christie. À l'image d'Hercule Poirot observant ses compagnons de voyage avec circonspection, il n'est pas rare de se demander qui au juste fait route avec vous (Christie, 1934 : 24-30). C'est la défiance qui règne, non le climat euphorique des premiers voyages.\n\nEt ce n'est là qu'un échantillon de l'abondante littérature Orient-Express de l'entre-deux-guerres. Certes, il s'agit de fictions ; gardons cependant à l'esprit que P.",

  // Chunk 38
  "Et ce n'est là qu'un échantillon de l'abondante littérature Orient-Express de l'entre-deux-guerres. Certes, il s'agit de fictions ; gardons cependant à l'esprit que P. Morand est un écrivain diplomate et qu'A. Christie est une grande habituée de l'Orient-Express ; elle s'est d'ailleurs inspirée pour l'écriture de son roman de ses propres voyages et de faits divers qui ont nourri l'actualité (le train pris dans une tempête de neige en 1929 et l'assassinat du bébé Lindbergh en 1932).",

  // Chunk 39
  "Ces écrits sont donc presque des chroniques, à tout le moins reflètent l'air du temps ; sans compter qu'on trouve occasionnellement dans la presse quotidienne des récits de trafics, d'agressions, de crimes et de voyages clandestins dans l'Orient-Express (El Gammal, 2017 : 221-222 ; 2021). Aussi les Années folles et les années sombres se côtoient-elles sans véritable solution de résorption : ce qui est sûr, c'est que des individus suspects, dangereux ou repoussants circulent désormais dans le train aux côtés des voyageurs habituels.\n\n1939-1945 : nouvelle guerre, nouvel arrêt du train.",

  // Chunk 40
  "1939-1945 : nouvelle guerre, nouvel arrêt du train. Celui-ci repart en 1945 mais ses voitures sont très abîmées ; privé de wagon-restaurant, il perd dès 1948 son label de train de luxe. Il disparaît peu à peu, victime de la concurrence de l'avion et des tensions de la Guerre froide. La traversée du rideau de fer en Yougoslavie crée des retards et le trajet est interminable, ce qui est manifeste dans *Bons Baisers de Russie* (1957), où James Bond prend le train à Istanbul à destination de Paris (Fleming, 1957 : 721-764).",

  // Chunk 41
  "Le public des années 1950, 1960 et 1970 change, là encore, avec quelques voyageurs inattendus, comme des hippies se rendant à Istanbul, étape importante du *hippie trail* sur la route de Katmandou. On ne s'étonnera pas de les voir consommer ou transporter des substances illicites dans les wagons fatigués de l'Orient-Express, comme c'est le cas de la jeune Tooley dans *Voyages avec ma tante* de Graham Greene (1904-1991 ; 1969 : 133-143).",

  // Chunk 42
  "Les « Adieux » à l'Orient-Express se multiplient dans les journaux dès les années 1960 (Morand, 1962 : 45-56) : il s'agit de notes nécrologiques qui reviennent avec nostalgie sur les belles années de l'Orient-Express. Mais si l'on fait ses adieux au train, on ne peut visiblement pas s'en passer, et c'est pourquoi, après plusieurs coups d'arrêt sérieux et un dernier voyage à Istanbul en 1977, il ressuscite encore de ses cendres.\n\n---\n\n## La renaissance du train et de la marque Orient-Express (depuis 1982)",
  ...
  // Chunk 54
  "---\n\nL'Orient-Express, depuis sa création en 1883, a toujours fasciné. Pourquoi ? C'est d'abord un objet hors du commun ; surtout, une extraordinaire publicité a été faite autour de lui, toutes périodes confondues : pensons aux récits enthousiastes des journalistes vedettes invités par G. Nagelmackers lors du voyage inaugural de 1883.",

  // Chunk 55
  "Nagelmackers lors du voyage inaugural de 1883. Edmond About (1828-1885 ; 1884), romancier bien connu et journaliste au XIXe siècle, et Henri Opper de Blowitz (1825-1903 ; 1884), journaliste au *Times*, considéré comme le père de l'interview moderne, y vantent la prodigalité de leur hôte, qui leur a réservé des mets savoureux, des pauses musicales et même une visite au beau château de Peleș en Roumanie, où les ont accueillis le roi et la reine ; or ces récits sont toujours cités par les thuriféraires de l'Orient-Express.",

  // Chunk 56
  "Il y a eu ensuite les changements opérés par Lord Dalziel dans les années 1920, puis le travail de **Jean-Paul Caracalla** (1921-2019), directeur de la communication de la Compagnie Internationale des Wagons-Lits dans les années 1960, auteur de maints ouvrages sur le train, qui a lancé le mythe du train chéri des écrivains, de P. Morand, A. Christie et G. Greene, lesquels n'ont jamais écrit une ligne favorable au train, sauf, s'agissant de P. Morand, quand J.-P. Caracalla lui a commandé un « Adieu au train » dans les années 1960.",

  // Chunk 57
  "Morand, quand J.-P. Caracalla lui a commandé un « Adieu au train » dans les années 1960. Enfin, dans les années 2020, il y a un battage médiatique autour de la bataille entre Accor/SNCF et LVMH.\n\n---\n\nMais revenons au projet de G. Nagelmackers, qui était l'union des États européens. Force est de constater, au regard de l'Histoire, que l'Orient-Express n'a fait que révéler leur désunion ; le train a été victime des guerres qui ont sévi en Europe.",

  // Chunk 58
  "Force est de constater, au regard de l'Histoire, que l'Orient-Express n'a fait que révéler leur désunion ; le train a été victime des guerres qui ont sévi en Europe. Restent les images qu'on associe au train, sorte de combinaison gagnante soigneusement entretenue par les détenteurs de la marque : l'Orient, le luxe, les Années Folles, l'art du voyage (avec ici un leurre, une ignorance ou une inconséquence : on vante le retour au *slow travel* mais à ses débuts, l'Orient-Express était le moyen de transport le plus rapide et les voyageurs pestaient lorsque le train décélérait).",

  // Chunk 59
  "Il y a plusieurs Orient-Express, plusieurs parcours, plusieurs périodes, plusieurs types de voyageurs. Aussi ne peut-on pas tenir de discours totalement univoque au sujet de ce train, qui garde une part d'ombre même lorsque tous les projecteurs révèlent ses splendeurs. Il est et n'est pas seulement le train que chacun se représente.\n\n---\n\n## Bibliographie\n\n- About E., 1884, *De Pontoise à Stamboul*, Paris, Hachette.\n- Benacquista T., 1989, *La Maldonne des sleepings*, Paris, Gallimard.\n- Christie A., 1934, *Le Crime de l'Orient-Express*, trad. de l'anglais par L.",

  // Chunk 60
  "Postif, Paris, Librairie des Champs-Elysées, 1966.\n- Clémente-Ruiz A., dir., 2014, *Il était une fois l'Orient-Express*, Gand, Snoeck.\n- Collet E., dir., 1997, *L'Orient-Express. Le voyage à Constantinople*, Bruxelles, Éd. Pandora.\n- Damour P., 2022, « L'Orient-Express, un train légendaire désormais partagé entre Accor et LVMH », *Challenges*, 22 juin.\n- Dekobra M., 1925, *La Madone des Sleepings*, Paris, Zulma, 2006.\n- Des Cars J., Caracalla J.-P., 1984, *L'Orient-Express, un siècle d'aventures ferroviaires*, Paris, Denoël.\n- El Gammal B., 2017, *L'Orient-Express. Du voyage extraordinaire aux illusions perdues*, Paris, Éd.",

  // Chunk 61
  "Du voyage extraordinaire aux illusions perdues*, Paris, Éd. Les Belles Lettres.\n- El Gammal B., 2021, *L'Orient-Express raconté par les écrivains*, Paris, Éd. Phébus/Éd. Libella.\n- Fleming I., 1957, *Bons baisers de Russie*, trad. de l'anglais par A. Gilliard, Paris, R. Laffont, 2011.\n- Greene G., 1969, *Voyages avec ma tante*, trad. de l'anglais par G. Belmont, Paris, Éd. 10/18, 2009.\n- Lauzanne S., 1913, *Au chevet de la Turquie. Quarante jours de guerre*, Paris, A.",

  // Chunk 62
  "Belmont, Paris, Éd. 10/18, 2009.\n- Lauzanne S., 1913, *Au chevet de la Turquie. Quarante jours de guerre*, Paris, A. Fayard.\n- Mettetal A., 2022, *Orient-Express & Cie, Histoire et patrimonialisation d'une marque ferroviaire (XIXe – XXIe siècles)*, thèse en histoire et en patrimoine industriel, École des hautes études en sciences sociales.\n- Montet J., 1886, *De Paris aux Karpathes*, Paris, Hachette.\n- Morand P., 1922, « La nuit turque », in : *Ouvert la nuit*, Paris, Gallimard.\n- Morand P., 1962, « Adieu à l'Orient-Express », in : *Le Voyage*, Paris, A.",
