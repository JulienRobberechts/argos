...
function ResultsScreen({
  ...
  return (
    <div className="max-w-xl space-y-5">
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-4 text-center">
        ...
        <button
          onClick={onRestart}
          className="mt-2 flex items-center gap-2 mx-auto px-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors"
        >
          <RotateCcw size={14} />
          New quiz
        </button>
